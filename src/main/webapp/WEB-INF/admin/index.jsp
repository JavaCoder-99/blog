...
<div class="header">
    <div style="margin: 0 45% 0 45%;padding-top:5%;text-align:center;">
        <div style="height:16%;width:90%;background:black;text-align:center;">
            <h3 style="font-family: Menlo;color:white;padding-top:5%;"><strong>年轮博客</strong></h3>
        </div>
        <h4 style="margin-top:16%;margin-left:-10%;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <span style="font-size:20px;" class="fa fa-qq fa-fw"></span>
            <br/>
            <label><a href="http://github.com/SweeperNL">GitHub</a></label>
            &nbsp;&nbsp;&nbsp;
            <label><a href="http://bk.google2015.cn">Blog</a></label>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <label><a href="http://wpa.qq.com/msgrd?v=3&uin=1146965132&site=qq&menu=yes">QQ</a></label>
        </h4>
    </div>
</div>
...
<div class="container">
    <div id="content">
        ...
        <!-- 登录的表单 -->
        <form action="<%=basePath%>/admin/login" id="loginform" method="post" class="layui-form"
        ...
        <!-- 注册的表单 -->
        <form action="<%=basePath%>/admin/register" id="registerform" method="post" class="layui-form" hidden="hidden"
              style="text-align: center;margin-right:12%;margin-top:10%;">
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    <label class="layui-form-label" style="margin-left:13%;"><i class="fa fa-user fa-fw"></i></label>

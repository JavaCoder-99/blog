...
<div class="container" style="width:80%;">
    ...
    <div style="border-left: 3px solid #f44336;">
        ...
        <div>
            ...
            <span style="font-size:16px;">本项目所有解释权归作者<strong>${article.r_author}</strong>所有</span>
        </div>
        <br/>
    </div>
    <br/>
    ...
    <div style="margin:0 4% 0 4%;">
        <br/>
        <!-- 留言的表单 -->
        <form class="layui-form" action="<%=basePath%>/article/saveWords" method="post">
            <input name="lw_name" value="${name}" hidden="hidden"/>
                        ...
                        <li style="border-top: 1px dotted #01AAED">
                            ...
                            <div>
                                ...
                                <div class="replycontainer layui-hide" style="margin-left: 61px;">
                                    <form action="<%=basePath%>/article/saveReply" method="post" class="layui-form">
                                        <input name="lr_for_article_id" id="lr_for_article_id" value="${article.r_id}" hidden="hidden"/>
                                        <input name="lr_name" id="lr_name" value="${name}" hidden="hidden"/>
...
<script type="text/javascript">
    ...
    $("#replyBtn").click(function(){
        ...
        $.ajax({
            url: '<%=basePath%>/article/saveReply',
            type: 'POST',
            data: [{

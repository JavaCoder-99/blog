...
<div class="container" style="width:80%;">
    <div style="margin-top: 60px;">
        <fieldset class="layui-elem-field layui-field-title">
            <legend style="margin-left: 20px;padding: 0 10px;text-align: left;width: 100px;border-bottom: none;"><strong>文章更新</strong>
            </legend>
        </fieldset>
    </div>
    <!-- 文章信息的表单 -->
        ...
        <form>
            <div class="layui-inline" style="margin-left: -10px;">
                ...
                <div class="layui-input-inline" style="margin-left:87px;">
                    <input type="text" name="r_author" id="r_author" value="${article.r_author}" class="layui-input" readonly="readonly"/>
                </div>
                ...
                <div class="layui-input-inline" style="margin-left: 88px;">
                    <input type="text" name="date" id="r_date" value="${article.r_date}" class="layui-input" readonly="readonly"/>
                </div>
            </div>

...
<div class="container" style="width: 95%;">
    ...
    <form class="listForm" name="listForm" method="post" action="<%=basePath%>/article/findByTrash">
        <div class="row">
            <div class="form-inline" style="margin-left: 15px;">
                ...
                <ul class="pagination" style="float:right;">
                    <li>
                        <a href="<%=basePath%>/article/findByTrash?pageCode=1"><strong>首页</strong></a>
                    </li>
                    <li>
                        <c:if test="${page.pageNum > 2}">
                            <a href="<%=basePath%>/article/findByTrash?pageCode=${page.pageNum - 1}">&laquo;</a>
                        </c:if>
                    </li>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:set var="begin" value="${page.pageNum - 1}"/>
                    ...
                    <c:forEach var="i" begin="${begin}" end="${end}">
                        ...
                        <c:if test="${i != page.pageNum}">
                            <li>
                                <a href="<%=basePath%>/article/findByTrash?pageCode=${i}">${i}</a>
                            </li>
                        </c:if>
                    </c:forEach>
                    ...
                    <li>
                        <c:if test="${page.pageNum < page.pages}">
                            <a href="<%=basePath%>/article/findByTrash?pageCode=${page.pageNum + 1}">&raquo;</a>
                        </c:if>
                    </li>
                    <li>
                        <a href="<%=basePath%>/article/findByTrash?pageCode=${page.pages}"><strong>末页</strong></a>
                    </li>
                </ul>
            </div>
        </div>

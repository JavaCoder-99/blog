...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <%--            <li class="layui-nav-item"><a href="<%=basePath%>/admin/" style="text-decoration: none;"><strong>首页</strong></a></li>--%>
        <%--        </ul>--%>
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <hr/>
                    <dd><a href="<%=basePath%>/admin/outLogin" style="text-decoration: none;;"><strong>退出登录</strong></a>
                    </dd>
                </dl>
            </li>
            <li class="layui-nav-item">
            ...
            <li class="layui-nav-item"><a href="<%=basePath%>/admin/outLogin"
    ...
    <div class="layui-body">
        <div id="content">
            <div style="font-size: 45px;color: #1D9D73;margin-top: 300px;" class="text-center">
                <strong>欢迎登录年轮博客后台管理系统</strong></div>
            <p class="text-center">
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        <strong>© 博客后台管理系统&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;---->&nbsp;Create by 年轮</strong>
...
<script type="text/javascript">
    ...
    function toArticleManage() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/article/findByPage\" width=\"100%\" height=\"100%\"></object>";
    }

    function toArticleTrash() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/article/findByTrash\" width=\"100%\" height=\"100%\"></object>";
    }
</script>
</html>